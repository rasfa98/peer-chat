...
module.exports = "<ul>\n  <li *ngFor=\"let user of onlineUsers\">{{user.fullName}}<button (click)=\"signal(user.id)\">Signal</button>\n    <button (click)=\"send(message.value)\">Send</button><input type=\"text\" #message></li>\n</ul>\n"
...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this.socket.on('updateOnlineUsers', function (users) {
            _this.onlineUsers = users;
        });
        this.userService.getCurrentUser()
            .subscribe(function (currentUser) {
            _this.currentUser = currentUser;
            _this.socket.emit('newUser', currentUser);
        });
        ...
        this.peer.on('data', function (data) { return console.log(data); });
    };
    ChatComponent.prototype.signal = function (id) {
