...
module.exports = "<app-animal></app-animal>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_animal_animal_component__ = __webpack_require__("./src/app/components/animal/animal.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_database_service__ = __webpack_require__("./src/app/services/database.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__components_animal_animal_component__["a" /* AnimalComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__services_database_service__["a" /* DatabaseService */]],
...
var AnimalComponent = /** @class */ (function () {
    function AnimalComponent(databaseService) {
    ...
    AnimalComponent.prototype.addAnimal = function () {
        var _this = this;
        var animal = {
            name: this.name,
            age: this.age
        ...
        this.databaseService.saveAnimal(animal)
            .subscribe(function (animal) { return _this.animals.push(animal); });
        return false;
    };
    AnimalComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'app-animal',
            template: __webpack_require__("./src/app/components/animal/animal.component.html"),
            styles: [__webpack_require__("./src/app/components/animal/animal.component.css")]
        }),
